...
class device(models.Model):
    ...
    devicemode = models.IntegerField(default = 1, null = True, blank = True)
    openTime = models.DateTimeField(null = True, blank = True)	# 設置開啟時間
    closeTime = models.DateTimeField(null = True, blank = True)	# 設置關閉時間
